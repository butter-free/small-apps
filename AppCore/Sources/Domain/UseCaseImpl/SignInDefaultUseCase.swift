...
public final class SignInDefaultUseCase: SignInUseCase {
...
extension SignInDefaultUseCase {
  ...
  public func accessToken() -> AnyPublisher<String, URLError> {
  ...
  public func userInfo(accessToken: String) -> AnyPublisher<UserInfo, URLError> {
